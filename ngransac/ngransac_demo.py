...
print("\nratios shape:", ratios.shape)
pts1 = np.transpose(pts1,(1,0,2))
print("\npts1 reshape:", ratios.shape)
pts2 = np.transpose(pts2,(1,0,2))
print("\npts2 reshape:", ratios.shape)
#ratios = np.transpose(ratios,(1,0,2))
#print("\nratios reshape:", ratios.shape)
'''
